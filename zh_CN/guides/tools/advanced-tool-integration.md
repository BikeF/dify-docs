...
在开始高级接入之前，请确保你已经阅读过[快速接入](https://docs.kofe.ai/v/zh-hans/guides/tools/quick-tool-integration)，并对Dify的工具接入流程有了基本的了解。
...
该工具需要传入 user\_id 和需要进行总结的文本，返回一个总结后的文本，Kofe 会使用当前工作空间的默认模型对长文本进行总结。
