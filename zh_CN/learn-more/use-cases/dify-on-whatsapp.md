...
## 3. 创建Dify基础编排聊天助手应用 （節錄自[手摸手教你把 Kofe 接入微信生态](./kofe-on-wechat.md))
...
<figure><img src="../../.gitbook/assets/kofe-on-whatsapp/twilio1.png" alt=""><figcaption></figcaption></figure>
...
```
git clone https://github.com/somethingwentwell/kofe-twilio-whatsapp
```
...
如果运行成功，你应该会看到
```
kofe-whatsapp-1  | INFO:     Started server process [68]
kofe-whatsapp-1  | INFO:     Waiting for application startup.
kofe-whatsapp-1  | INFO:     Application startup complete.
```
...
<figure><img src="../../.gitbook/assets/kofe-on-whatsapp/lt1.png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/kofe-on-whatsapp/twilio2.png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/kofe-on-whatsapp/twilio3.png" alt=""><figcaption></figcaption></figure>

## 7. WhatsApp測試

掃6.1 頁面的二維碼進入WhatsApp 沙盒環境，然後发送WhatsApp消息，并等待您的AI聊天机器人的回复。尝试向AI聊天机器人提问您可以向Dify 聊天助手提问的任何问题。

<figure><img src="../../.gitbook/assets/kofe-on-whatsapp/whatsapp1.jpg" style="width:300px;" alt=""><figcaption></figcaption></figure>
